...
import com.frame.usercenter.dialog.custom.CustomImageViewerPopup;
...
import static com.frame.usercenter.dialog.Constants.list;
...
public class ImageViewerDemo extends BaseFragment {
    ...
    public void init(final View view) {
        ...
        Glide.with(this).load(url1).apply(new RequestOptions().placeholder(R.mipmap.icon_face_sad).override(Target.SIZE_ORIGINAL).transform(new RoundedCorners(50))).into(image1);
...
//                viewerPopup.isShowSaveButton(false);//是否显示保存按钮
    ...
    public static class ImageAdapter extends EasyAdapter<Object> {
        ...
        protected void bind(@NonNull final ViewHolder holder, @NonNull final Object s, final int position) {
            ...
            Glide.with(imageView).load(s).apply(new RequestOptions().placeholder(R.mipmap.icon_face_sad)
    ...
    class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, final int position) {
            ...
            //1. 加载图片
            Glide.with(imageView).load(list.get(position)).apply(new RequestOptions().placeholder(R.mipmap.icon_face_sad).override(Target.SIZE_ORIGINAL))
                    .into(imageView);
            //2. 设置点击
            imageView.setOnClickListener(new View.OnClickListener() {
                @Override
...
//                            Log.e("tag", "position: "+realPosi + " list size: "+list.size());
    ...
    public static class ImageLoader implements XPopupImageLoader {
        ...
        public void loadImage(int position, @NonNull Object url, @NonNull ImageView imageView) {
            ...
            Glide.with(imageView).load(url).apply(new RequestOptions().placeholder(R.mipmap.icon_face_sad).override(Target.SIZE_ORIGINAL)).into(imageView);
        }
        @Override
