package com.frame.usercenter.dialog.fragment;
...
import com.frame.usercenter.dialog.DemoActivity;
import com.frame.usercenter.dialog.UserCenterMainActivity;
import com.frame.usercenter.dialog.custom.CustomAttachPopup;
import com.frame.usercenter.dialog.custom.CustomAttachPopup2;
import com.frame.usercenter.dialog.custom.CustomDrawerPopupView;
import com.frame.usercenter.dialog.custom.CustomEditTextBottomPopup;
import com.frame.usercenter.dialog.custom.CustomFullScreenPopup;
import com.frame.usercenter.dialog.custom.PagerBottomPopup;
import com.frame.usercenter.dialog.custom.PagerDrawerPopup;
import com.frame.usercenter.dialog.custom.QQMsgPopup;
import com.frame.usercenter.dialog.custom.ZhihuCommentPopup;
...
//                        .popupPosition(PopupPosition.Top) //手动指定弹窗的位置
                    ...
                    .asAttachList(new String[]{"分享", "编辑编辑编辑编辑", "不带icon"},
                            new int[]{R.mipmap.icon_face_sad, R.mipmap.icon_face_smile},
                            new OnSelectListener() {
                                @Override
                                public void onSelect(int position, String text) {
                                    toast("click " + text);
                        ...
                        public void run() {
                            new XPopup.Builder(getContext())
                                    ...
                                    .asConfirm("XPopup牛逼", "XPopup支持直接在后台弹出！", new OnConfirmListener() {
                                        @Override
                                        public void onConfirm() {
                                            startActivity(new Intent(getContext(), UserCenterMainActivity.class));
                                        }
                                    }).show();
                        }
                    }, 2000);
